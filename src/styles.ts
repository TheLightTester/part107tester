...
export const styles = {
  ...
  heroStats: (isMobile = false): StyleObj => ({
    display: 'flex',
    gap: isMobile ? 16 : 32,
    flexWrap: isMobile ? 'wrap' : 'nowrap',
  }),
  statsGrid: (isMobile = false): StyleObj => ({
    display: 'grid',
  ...
  heroStatLabel: { fontSize: 12, color: '#64748b', letterSpacing: '0.06em', textTransform: 'uppercase' } satisfies StyleObj,
  sectionTitle: {
    fontSize: 12, fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase',
    color: '#64748b', marginBottom: 16,
  } satisfies StyleObj,
  moduleGrid: (isMobile = false): StyleObj => ({
    display: 'grid',
  ...
  moduleWeight: { fontSize: 12, color: '#64748b', fontWeight: 600 } satisfies StyleObj,
  ...
  lessonRow: (done: boolean, isMobile = false): StyleObj => ({
    display: 'flex',
  ...
  lessonCheck: (done: boolean, color: string): StyleObj => ({
    ...
    display: 'flex', alignItems: 'center', justifyContent: 'center',
    color: done ? color : '#6b7280', flexShrink: 0,
  }),
  ...
  readTime: { fontSize: 12, color: '#6b7280' } satisfies StyleObj,
  lessonHeader: {
  ...
  keyFactDot: { color: '#4A9EE8', marginTop: 5, flexShrink: 0, fontSize: 12 } satisfies StyleObj,
  memAid: {
  ...
  quizQuestionNum: { fontSize: 12, color: '#6b7280', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 10 } satisfies StyleObj,
  quizQuestionText: { fontSize: 16, fontWeight: 600, lineHeight: 1.6, marginBottom: 6 } satisfies StyleObj,
  quizReg: { fontSize: 12, color: '#6b7280', fontStyle: 'italic' } satisfies StyleObj,
  quizOptions: { display: 'flex', flexDirection: 'column', gap: 8 } satisfies StyleObj,
  quizOption: (state: string, isMobile = false): StyleObj => {
    const base: StyleObj = {
      display: 'flex', alignItems: 'flex-start', gap: 12,
      padding: isMobile ? '14px 18px' : '12px 16px', borderRadius: 7, cursor: 'pointer',
      transition: 'all 0.15s', fontSize: isMobile ? 15 : 14, lineHeight: 1.5,
    }
  ...
  explanationReg: { fontSize: 12, color: '#6b7280', marginTop: 6, fontStyle: 'italic' } satisfies StyleObj,
  resultsCard: {
  ...
  resultsStatLabel: { fontSize: 12, color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.08em' } satisfies StyleObj,
  reviewBtn: {
  ...
  lockBadge: {
    ...
    fontSize: 13, fontWeight: 700, cursor: 'pointer',
    border: '1px solid #2d3748', transition: 'all 0.15s',
  } satisfies StyleObj,
  certificateCard: {
    background: '#111827',
